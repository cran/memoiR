...
\Authors{
$for(author)$$author.name$\textsuperscript{$author.authsuperscript$}$if(author.orcid)$\orcidlink{$author.orcid$}$endif$$sep$$authorseparator$ $endfor$
} % Authors
\affiliation{
...
\JEL{$for(JEL)$$JEL$$sep$, $endfor$} % JEL codes
\newcommand{\JELname}{$JELlabel$} % Defines the JEL heading name

\Acknowledgements{$acknowledgements$} % Acknowledgements
\newcommand{\acknowledgementsname}{$acknowledgementslabel$} % Defines the heading name
