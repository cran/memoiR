...
Along with a GitBook version to be read online, their PDF version based on the LaTeX class **memoir** can be highly customized (see examples [1](https://ericmarcon.github.io/travailleR/travailleR.pdf) and [2](https://ericmarcon.github.io/memoiR/gallery/memoir/bookdown_pdf_book/MyBook.pdf)).
...
The HTML version is a GitBook and the PDF version is formatted by the memoir LaTeX template.
...
- or directly create a project with the appropriate wizard:
    - Use the menu "File > New Project > New Diretory > Document Project using memoiR".
